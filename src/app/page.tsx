    ...
    <div className="min-h-screen" style={{ background: '#0A0A0A', color: '#E5E2E1' }}>
      ...
      <header className="sticky top-0 z-50" style={{ background: '#0A0A0ACC', borderBottom: '1px solid #262626', backdropFilter: 'blur(20px)' }}>
        <div className="mx-auto flex items-center justify-between h-16 px-4 lg:px-16" style={{ maxWidth: 1280 }}>
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 flex items-center justify-center" style={{ background: '#22C55E' }}>
          ...
          <div className="hidden md:block">
            <Link href="/dashboard">
              <button className="h-9 px-4 text-sm font-semibold transition-all" style={{ background: '#22C55E', color: '#0A0A0A', border: 'none' }}>
        ...
        {mobileMenu && (
          <div className="md:hidden p-4 space-y-3" style={{ borderTop: '1px solid #262626', background: '#0A0A0A' }}>
            ...
            <Link href="/dashboard">
              <button className="w-full h-10 text-sm font-semibold" style={{ background: '#22C55E', color: '#0A0A0A', border: 'none' }}>Commencer gratuitement</button>
            </Link>
          </div>
        )}
      </header>
      ...
      <section className="mx-auto px-4 lg:px-16 py-20 lg:py-32" style={{ maxWidth: 1280 }}>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-semibold mb-6" style={{ background: 'rgba(34, 197, 94, 0.08)', border: '1px solid rgba(34, 197, 94, 0.2)', color: '#22C55E', fontFamily: 'Geist, monospace', letterSpacing: '0.1em' }}>
              <Sparkles size={14} />
              QR CODES DYNAMIQUES
            </div>
            <h1 className="font-bold leading-tight mb-4" style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 64, letterSpacing: '-0.02em', lineHeight: '1.1' }}>
              QR Codes qui<br />
              <span style={{ color: '#22C55E' }}>s'adaptent</span>.
              <br />
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/dashboard">
                <button className="h-12 px-6 text-sm font-semibold flex items-center gap-2 transition-all" style={{ background: '#22C55E', color: '#0A0A0A', border: 'none' }}>
                  <Zap size={18} />
                  Générer mon QR code
                </button>
              </Link>
          ...
          <div className="hidden lg:flex items-center justify-center">
            <div className="relative flex items-center justify-center" style={{ width: 300, height: 300, background: '#161616', border: '1px solid #262626' }}>
              <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(34,197,94,0.08), rgba(255,215,0,0.08))' }} />
              <div className="flex items-center justify-center z-10" style={{ width: 200, height: 200, background: '#0A0A0A' }}>
                <QrCode size={80} style={{ color: '#22C55E', opacity: 0.8 }} />
              </div>
              <div className="absolute -bottom-3 -right-3 flex items-center justify-center z-10" style={{ width: 80, height: 80, background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.2)' }}>
                <ScanLine size={28} style={{ color: '#22C55E' }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto px-4 lg:px-16 py-10" style={{ maxWidth: 1280 }}>
          <div className="grid grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={stat.label}>
                <p className="text-2xl lg:text-3xl font-bold font-mono" style={{ color: '#22C55E', fontFamily: 'Geist, monospace' }}>{stat.value}</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            return (
              ...
              >
                <div className="w-12 h-12 flex items-center justify-center mb-4" style={{ background: 'rgba(34,197,94,0.1)' }}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mx-auto" style={{ maxWidth: 640 }}>
          ...
          <div className="p-8" style={{ background: '#161616', border: '1px solid #262626' }}>
            ...
            <ul className="space-y-3 text-sm mb-8" style={{ color: '#C5C9AC' }}>
              <li className="flex items-center gap-2"><Check size={14} style={{ color: '#22C55E' }} /> 5 QR codes max</li>
              <li className="flex items-center gap-2"><Check size={14} style={{ color: '#22C55E' }} /> Redirection dynamique</li>
              <li className="flex items-center gap-2"><Check size={14} style={{ color: '#22C55E' }} /> Analytics 7 jours</li>
              <li className="flex items-center gap-2"><Check size={14} style={{ color: '#22C55E' }} /> Export PNG</li>
            </ul>
            <Link href="/dashboard">
          ...
          {/* PRO */}
          <div className="p-8 relative" style={{ background: 'rgba(34,197,94,0.04)', border: '1px solid rgba(34,197,94,0.3)' }}>
            <div className="absolute -top-3 right-4 px-3 py-1 text-xs font-semibold" style={{ fontFamily: 'Geist, monospace', letterSpacing: '0.1em', background: '#22C55E', color: '#0A0A0A' }}>
              POPULAIRE
            </div>
            <h3 className="font-semibold mb-2" style={{ color: '#E5E2E1', fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 24 }}>PRO</h3>
            <p className="mb-4 font-bold font-mono" style={{ fontSize: 36, fontFamily: 'Geist, monospace', color: '#22C55E' }}>
              2 900 FCFA
              <span className="text-sm font-sans font-normal" style={{ color: '#A1A1A1' }}>/mois</span>
            </p>
            <ul className="space-y-3 text-sm mb-8" style={{ color: '#C5C9AC' }}>
            ...
            <Link href="/dashboard">
              <button className="w-full h-11 text-sm font-semibold flex items-center justify-center gap-1.5 transition-all" style={{ background: '#22C55E', color: '#0A0A0A', border: 'none', boxShadow: '0 0 20px rgba(34,197,94,0.15)' }}
                onMouseOver={e => e.currentTarget.style.boxShadow = '0 0 30px rgba(34,197,94,0.3)'}
                onMouseOut={e => e.currentTarget.style.boxShadow = '0 0 20px rgba(34,197,94,0.15)'}
              >
                <Zap size={16} />
                Choisir PRO
              </button>
      ...
      <section className="mx-auto px-4 lg:px-16 py-20 text-center" style={{ maxWidth: 1280, borderTop: '1px solid #262626' }}>
        <h2 className="font-bold mb-4" style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontSize: 40, letterSpacing: '-0.01em' }}>
          Prêt à <span style={{ color: '#22C55E' }}>digitaliser</span> vos QR codes ?
        </h2>
        ...
        <Link href="/dashboard">
          <button className="h-12 px-8 text-sm font-semibold transition-all" style={{ background: '#22C55E', color: '#0A0A0A', border: 'none' }}>
            Commencer gratuitement → 
          </button>
        </Link>
      </section>
      ...
      <footer className="py-8 px-4 lg:px-16" style={{ borderTop: '1px solid #262626', maxWidth: 1280, margin: '0 auto' }}>
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <div className="w-6 h-6 flex items-center justify-center" style={{ background: '#22C55E' }}>
